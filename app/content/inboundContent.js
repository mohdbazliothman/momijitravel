...
export const inboundContent = {
  home: {
    ...
    destinations: {
      ...
      title: "Places to Explore in Malaysia",
      items: [
        ["Kuala Lumpur", "Modern skyline, city icons, shopping, food and cultural neighbourhoods."],
        ["Melaka", "UNESCO-style heritage streets, riverfront atmosphere and local cultural learning."],
        ["Penang", "Heritage, street food, arts, coastal scenery and multicultural local life."],
        ["Langkawi", "Island landscapes, beaches, nature attractions and relaxed resort-style travel."],
        ["Cameron Highlands", "Cool climate, tea country, farms and scenic highland drives."],
        ["Genting Highlands", "Cool mountain resort, entertainment, shopping and family-friendly attractions."],
      ],
    },
    experiences: {
